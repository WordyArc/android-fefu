        ...
        Column(
            ...
            Button(
                ...
                if (state.isLoading) {
                    ...
                    Text(
                        if (state.errorMessage != null) "Повторить"
                        else "Обновить"
                    )
                }
            }
            ...
            when {
                ...
                !state.isLoading && anime.isEmpty() -> {
                    val emptyText = when {
                        state.filter == AnimeFilter.FAVOURITES && state.query.isBlank() ->
                            "В избранном пока пусто"

                        state.filter == AnimeFilter.FAVOURITES ->
                            "В избранном ничего не найдено по запросу"
